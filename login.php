...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>EunameD</b>System</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Faça o login no sistema!</p>
    ...
    <div class="social-auth-links text-center">
      <p>- OU -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Iniciar com
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Iniciar com
        Google+</a>
    </div>
    <!-- /.social-auth-links -->

    <a href="#">Esqueci meu password</a><br>
