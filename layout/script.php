...
$url = 'http://localhost/clinica/views/';
...
<head>
  ...
  <title>Eunamed | Medical System</title>
  ...
  <link rel="stylesheet" href="https://kit.fontawesome.com/256d19675d.js" crossorigin="anonymous"">
  <!-- Ionicons -->
...
$header = '<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Eunamed</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="http://facebook.com/" class="link-social" >
          ...
          <li class="dropdown notifications-menu">
            <a href="http://google.com/" class="link-social" >
...
<!-- Produtos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="'.$url.'cliente/addempresa.php"><i class="fa fa-circle-o"></i>Adicionar Empresa</a></li>
